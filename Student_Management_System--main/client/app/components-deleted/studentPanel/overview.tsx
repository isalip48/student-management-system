...
export default function Overview() {
  return (
    <div className="w-full h-screen overflow-y-scroll overscroll-contain">
      {/* header */}
      <div className="bg-primary text-[#fff] p-4 rounded-lg flex justify-center items-center gap-12">
        <div className="flex flex-col">
          <h1 className="text-[1.4rem] lg:text-[1.8rem] font-bold flex flex-col md:flex-row">
            Hi Isali,!
          </h1>
